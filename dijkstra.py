...
def dijkstra_bus(start_id, end_id):
    ...
    path_id.reverse()
    bus_path = getBus2(path_id, start_id, end_id)
...
def getBus2(path_id, start_id, end_id):
    bus_graph = {}
...
#each element is [[list of buses serving segment], [list of stop ids visited by segment inc first and last]]
...
def getBus(path_id, start_id, end_id):
    ...
    for i in range(len(bus_path)):
        bus_path[i] = bus_path[i][1:]

    return bus_path

#readData()
#print(dijkstra_combined('13','302'))
=======
# readData()
# print(buildingNames)
...
# print(stopDict)
# print(nodeDict)
>>>>>>> 9f3a04a0680098ddb54ac867ecaf6f5100793b71
